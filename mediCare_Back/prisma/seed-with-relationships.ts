// prisma/seed-with-relationships.ts
import { PrismaClient, UserType, RelationshipType, User, Medication, Prescription, UserRelationship } from "@prisma/client";
...
async function main() {
  ...
  const doctorRelationships: UserRelationship[] = [];
