...
router.get('/reminders/upcoming', (req, res) => patientController.getUpcomingReminders(req, res));
router.get('/check-updates', (req, res) => patientController.checkForUpdates(req, res));
// Message endpoints
