...
export interface UserProfileData {
  ...
  bio?: string; // For all users
  profilePicture?: string; // For all users
  isActive: boolean;
  createdAt: Date;
  lastLogin?: Date;
  // Statistics (calculated based on user type)
  totalMedications?: number; // For patients
  adherenceRate?: number; // For patients
  totalPatients?: number; // For tutors/doctors
  totalPrescriptions?: number; // For doctors
  lastActivity: string;
}
...
export class UserService {
   ...
   */
  async updateUserProfile(userId: string, profileData: UpdateUserProfileData): Promise<void> {
    try {
   ...
   */
  private async getPatientStatistics(patientId: string) {
   ...
   */
  private async getTutorStatistics(tutorId: string) {
   ...
   */
  private async getDoctorStatistics(doctorId: string) {
    // Total patients
   ...
   */
  private async calculateLastActivity(userId: string, userType: UserType): Promise<string> {
