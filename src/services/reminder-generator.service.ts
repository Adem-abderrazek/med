...
export class ReminderGeneratorService {
   ...
   */
  async generateRemindersForDate(targetDate: Date): Promise<void> {
   ...
   */
  private async updateLastGeneratedAt(scheduleIds: string[]): Promise<void> {
   ...
   */
  async linkExistingRemindersToVoiceMessages(): Promise<void> {
